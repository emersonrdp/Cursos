...
namespace Cursos
{
    public partial class cadProfessores : Form
    {
        ...
        private void professorBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            try
            {
                this.idProfessorTextBox.Text = "-1";   // Devolver o valor "-1" para o campo, para que não de erro ao salvar o registro no banco de dados
                this.Validate();
